...
TEST_IMAGE = _find_fixture('TEST_IMAGE', 'alpine.JPG', 'casey-lee-awj7sRviVXo-unsplash.jpg')
TEST_LANDMARK_IMAGE = _find_fixture('TEST_LANDMARK_IMAGE', 'eiffeltower.jpg', 'alpine.JPG')
TEST_GEO_IMAGE = _find_fixture('TEST_GEO_IMAGE', 'geotagged.jpg', 'geotagged2.jpg')
TEST_FACE_IMAGE = _find_fixture('TEST_FACE_IMAGE',
...
class TestLandmarksParity:
    def test_landmarks(self):
        ...
        if node_result and python_result:
            ...
            print('One or both returned no landmarks (expected for non-landmark images)')


@pytest.mark.skipif(not TEST_FACE_IMAGE, reason='No face test image found in tests/res/FaceID-550/')
